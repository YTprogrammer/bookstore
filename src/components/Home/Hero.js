...
const Hero = () =>{
  return(
    <div className="h-[75vh] flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full lg:w-3/6 h-auto lg:h-[600px] flex items-center justify-center mt-16 overflow-hidden">
       <img className="w-full h-auto object-cover"  src="/hero.jpeg" alt="hero" />
      </div>
    </div>
  );
};
