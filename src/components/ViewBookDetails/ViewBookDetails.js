    ...
    return(
      ...
      {Data && (
          ...
          <div className="flex flex-col lg:flex-row justify-around bg-zinc-800 py-12 rounded">
            {" "}
          <img src={Data.cover} alt="/"  className="h-[50vh] md:h-[60vh] lg:h-[70vh] rounded"/>
           ...
           {isLoggedIn === true && role === "admin" && (
            ...
            <button className="bg-white rounded lg:rounded-full text-3xl p-3 flex items-center justify-center"> 
             <FaEdit />{" "}
             <span className="ms-4 block lg:hidden">Edit Books</span>
            </button>
            <button className="text-red-500 rounded lg:rounded-full text-3xl p-3  mt-8 md:mt-0 lg:mt-8 bg-white flex items-center justify-center">
             <MdOutlineDelete />{" "}
             <span className="ms-4 block lg:hidden">Delete Books</span>
            </button>
           </div>
           )}
          </div>
